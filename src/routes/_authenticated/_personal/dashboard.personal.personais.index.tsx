...
function PersonaisPage() {
  ...
  const roleLabel = (r: PersonalRow["role"]) =>
    r === "owner" ? "Dono" : r === "personal" ? "Personal" : "Equipe";
        ...
        <div className="sticky top-0 z-30 border-b border-border/60 bg-background/70 backdrop-blur-xl">
          <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-4 sm:px-6 md:px-8">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Link
                to="/dashboard/personal/academia"
        ...
        <div className="px-4 py-6 sm:px-6 md:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              ...
              <Link to="/dashboard/personal/academia" className="text-primary hover:underline">Equipe & convites</Link>.
            </p>
          </div>
        </div>
      </main>
