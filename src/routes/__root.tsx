...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dashboard · cactusfitness" },
      { name: "description", content: "Gerencie seus alunos, treinos e avaliações físicas em um só lugar." },
      { property: "og:title", content: "Dashboard · cactusfitness" },
      { property: "og:description", content: "Gerencie seus alunos, treinos e avaliações físicas em um só lugar." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@500;600;700;800&family=Space+Grotesk:wght@400;500;600;700&display=swap",
      },
    ],
  }),
...
function RootComponent() {
  ...
  useEffect(() => {
    try {
      const raw = localStorage.getItem("cactus.customization.v1");
      if (raw) {
