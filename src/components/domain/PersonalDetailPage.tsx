                  ...
                  <div className="mt-6 space-y-4 border-t border-border pt-4">
                    <div className="flex flex-wrap items-center gap-2">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold text-[oklch(0.72_0.18_45)] transition-all duration-200 hover:text-primary hover:shadow-[0_0_6px_var(--color-primary)]"
                      >
                      ...
                      {canManage && (
                        <>
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold text-[oklch(0.72_0.18_45)] transition hover:bg-[oklch(0.72_0.18_45)]/10"
                          >
                            <Lock className="h-3.5 w-3.5" /> {p.is_active ? "Desativar personal" : "Ativar personal"}
                          </button>
                          <button
                            onClick={() => setDeleteOpen(true)}
                            className="inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-semibold text-[oklch(0.68_0.22_25)] transition hover:bg-[oklch(0.68_0.22_25)]/10"
                          >
